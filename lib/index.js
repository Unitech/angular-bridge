...
AngularBridge.prototype.registerRoutes = function() {
  this.app.get(this.options.urlPrefix + ':resourceName', this.options.requestPrehandler, this.collection(), this.collectionGet());
  this.app.post(this.options.urlPrefix + ':resourceName', this.options.requestPrehandler, this.collection(), this.collectionPost());

  this.app.get(this.options.urlPrefix + ':resourceName/:id', this.options.requestPrehandler, this.entity(), this.entityGet());
  // // You can POST or PUT to update data
  this.app.post(this.options.urlPrefix + ':resourceName/:id', this.options.requestPrehandler, this.entity(), this.entityPut());
  this.app.put(this.options.urlPrefix + ':resourceName/:id', this.options.requestPrehandler, this.entity(), this.entityPut());

  this.app.delete(this.options.urlPrefix + ':resourceName/:id', this.options.requestPrehandler, this.entity(), this.entityDelete());
};
